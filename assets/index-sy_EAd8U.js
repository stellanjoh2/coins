...
`)+`
`+p);const y=b+m+a,E=b+p+o,w=Zu(i,i.VERTEX_SHADER,y),T=Zu(i,i.FRAGMENT_SHADER,E);i.attachShader(x,w),i.attachShader(x,T),t.index0AttributeName!==void 0?i.bindAttribLocation(x,0,t.index0AttributeName):t.morphTargets===!0&&i.bindAttribLocation(x,0,"position"),i.linkProgram(x);function R(I){if(s.debug.checkShaderErrors){const O=i.getProgramInfoLog(x)||"",k=i.getShaderInfoLog(w)||"",Y=i.getShaderInfoLog(T)||"",j=O.trim(),K=k.trim(),Q=Y.trim();let q=!0,ie=!0;if(i.getProgramParameter(x,i.LINK_STATUS)===!1)if(q=!1,typeof s.debug.onShaderError=="function")s.debug.onShaderError(i,x,w,T);else{const ae=Qu(i,w,"vertex"),be=Qu(i,T,"fragment");We("THREE.WebGLProgram: Shader Error "+i.getError()+" - VALIDATE_STATUS "+i.getProgramParameter(x,i.VALIDATE_STATUS)+`
